...
import ua.roman.flats.collector.domain.name.NameCity;
import ua.roman.flats.collector.domain.name.NameDistrict;
import ua.roman.flats.collector.domain.name.NameVoivodeship;
